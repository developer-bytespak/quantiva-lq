...
const sections = [
  ...
  },
  {
    ...
    background: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=1920&q=80",
  },
  {
    id: "portfolio",
    leftLabel: "Portfolio",
    ...
    background: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=1920&q=80",
  },
  {
    id: "multi-exchange",
    ...
    background: "https://images.unsplash.com/photo-1642790106117-e829e14a795f?w=1920&q=80",
  },
];

const SplitCardScroll = () => {
  const apiRef = React.useRef<FullScreenFXAPI>(null);

  return (
    <div style={{ fontFamily: 'serif', background: '#0f0f0f', color: 'white' }}>
      <FullScreenScrollFX
        sections={sections}
        header={
          <>
